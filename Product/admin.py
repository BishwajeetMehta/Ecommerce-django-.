...
from . models import Categories,products,System_setting,Order, Comment,Cart_Table,Cart_item
...
class Products(admin.ModelAdmin):
    list_display = ("id","name","Category","description","price","brand","image","stock","status")
